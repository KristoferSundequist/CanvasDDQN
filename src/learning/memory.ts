...
if (typeof process !== "undefined" && process.env["NODE_ENV"] === "test") {
    ...
    describe('prepareStates', () => {
        test('padAndCrop - Returns same size', () => {
            const memory = new ExperienceReplayBuffer(1000, 3, 1, 1)
        ...
        test('padAndCrop - moves pixel correctly when zero crop', () => {
            const memory = new ExperienceReplayBuffer(1000, 3, 1, 1)
        ...
        test('padAndCrop - moves pixel correctly when little x crop crop', () => {
            const memory = new ExperienceReplayBuffer(1000, 3, 1, 1)
            const inputState = tf.randomGamma([3, 3, 2], 0.5)
        ...
        test('padAndCrop - moves pixel correctly when little y crop crop', () => {
            const memory = new ExperienceReplayBuffer(1000, 3, 1, 1)
            const inputState = tf.randomGamma([3, 3, 2], 0.5)
